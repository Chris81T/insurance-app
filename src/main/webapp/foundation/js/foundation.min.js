...
(function (e) {
    ...
    Foundation.libs.dropdown = {name: "dropdown", version: "4.1.0", settings: {activeClass: "open"}, init: function (t, n, r) {
        ...
        e(this.scope).on("click.fndtn.dropdown", "[data-dropdown]", function (t) {
            ...
            e("[data-dropdown-content]").css(Foundation.rtl ? "right" : "left", "-99999px").removeClass(n.settings.activeClass)
        ...
        if (this.small())n.css({position: "absolute", width: "95%", left: "2.5%", "max-width": "none", top: i.top + this.outerHeight(r)}); else {
            if (!Foundation.rtl && e(t).width() > this.outerWidth(n) + r.offset().left)var s = i.left; else {
    ...
    "use strict";
    Foundation.libs.joyride = {name: "joyride", version: "4.1.2", defaults: {expose: !1, modal: !1, tipLocation: "bottom", nubPosition: "auto", scrollSpeed: 300, timer: 0, startTimerOnClick: !0, startOffset: 0, nextButton: !0, tipAnimation: "fade", pauseAfter: [], exposed: [], tipAnimationFadeSpeed: 300, cookieMonster: !1, cookieName: "joyride", cookieDomain: !1, cookieExpires: 365, tipContainer: "body", postRideCallback: function () {
        ...
        n = e(this.settings.template.expose), this.settings.$body.append(n), n.css({top: i.offset().top, left: i.offset().left, width: this.outerWidth(i, !0), height: this.outerHeight(i, !0)}), r = e(this.settings.template.exposeCover), s = {zIndex: i.css("z-index"), position: i.css("position")}, i.css("z-index", n.css("z-index") * 1 + 1), s.position == "static" && i.css("position", "relative"), i.data("expose-css", s), r.css({top: i.offset().top, left: i.offset().left, width: this.outerWidth(i, !0), height: this.outerHeight(i, !0)}), this.settings.$body.append(r), n.addClass(o), r.addClass(o), i.data("expose", o), this.settings.postExposeCallback(this.settings.$li.index(), this.settings.$next_tip, i), this.add_exposed(i)
    }, un_expose: function () {
        var n, r, i, s, o = !1;
    ...
    "use strict";
    Foundation.libs.reveal = {name: "reveal", version: "4.1.2", locked: !1, settings: {animation: "fadeAndPop", animationSpeed: 250, closeOnBackgroundClick: !0, dismissModalClass: "close-reveal-modal", bgClass: "reveal-modal-bg", open: function () {
    }, opened: function () {
    }, close: function () {
    }, closed: function () {
    ...
    "use strict";
    Foundation.libs.section = {name: "section", version: "4.1.2", settings: {deep_linking: !1, one_up: !0, callback: function () {
    }}, init: function (e, t, n) {
        var r = this;
        ...
        e(this.scope).on("click.fndtn.section", "[data-section] .title, [data-section] [data-section-title]", function (t) {
            ...
            e(t.target).closest(".title, [data-section-title]").length < 1 && e('[data-section="vertical-nav"], [data-section="horizontal-nav"]').find("section, .section, [data-section-region]").removeClass("active").attr("style", "")
        })
    }, toggle_active: function (t, n) {
        var r = e(this), i = r.closest("section, .section, [data-section-region]"), s = i.find(".content, [data-section-content]"), o = i.closest("[data-section]"), n = Foundation.libs.section, u = e.extend({}, n.settings, n.data_options(o));
        n.settings.toggled = !0, !u.deep_linking && s.length > 0 && t.preventDefault();
        if (i.hasClass("active"))(n.small(o) || n.is_vertical(o) || n.is_horizontal(o) || n.is_accordion(o)) && i.removeClass("active").attr("style", ""); else {
            var a = null, f = n.outerHeight(i.find(".title, [data-section-title]"));
            if (n.small(o) || u.one_up)a = r.closest("[data-section]").find("section.active, .section.active, .active[data-section-region]"), n.small(o) ? a.attr("style", "") : a.attr("style", "visibility: hidden; padding-top: " + f + "px;");
        ...
        t.each(function () {
            var t = e(this), r = t.find("section.active, .section.active, .active[data-section-region]"), i = e.extend({}, n.settings, n.data_options(t));
            if (r.length > 1)r.not(":first").removeClass("active").attr("style", ""); else if (r.length < 1 && !n.is_vertical(t) && !n.is_horizontal(t) && !n.is_accordion(t)) {
                var s = t.find("section, .section, [data-section-region]").first();
                i.one_up && s.addClass("active"), n.small(t) ? s.attr("style", "") : s.css("padding-top", n.outerHeight(s.find(".title, [data-section-title]")))
            }
            n.small(t) ? r.attr("style", "") : r.css("padding-top", n.outerHeight(r.find(".title, [data-section-title]"))), n.position_titles(t), n.is_horizontal(t) && !n.small(t) ? n.position_content(t) : n.position_content(t, !1)
        })
        ...
        r.each(function () {
            ...
            n.length > 0 && r.deep_linking && (t.find("section, .section, [data-section-region]").attr("style", "").removeClass("active"), t.find('.content[data-slug="' + n + '"], [data-section-content][data-slug="' + n + '"]').closest("section, .section, [data-section-region]").addClass("active"))
        })
    }, position_titles: function (t, n) {
        var r = t.find(".title, [data-section-title]"), i = 0, s = this;
        ...
        var r = t.find(".title, [data-section-title]"), i = t.find(".content, [data-section-content]"), s = this;
        typeof n == "boolean" ? (i.attr("style", ""), t.attr("style", "")) : (t.find("section, .section, [data-section-region]").each(function () {
            var t = e(this).find(".title, [data-section-title]"), n = e(this).find(".content, [data-section-content]");
        ...
        var t = e.closest("[data-section]"), n = e.closest("[data-section]").width(), r = t.find(".title, [data-section-title]").length;
    ...
    "use strict";
    Foundation.libs.topbar = {name: "topbar", version: "4.1.2", settings: {index: 0, stickyClass: "sticky", custom_back_text: !0, back_text: "Back", init: !1}, init: function (n, r, i) {
        var s = this;
        ...
        e(this.scope).on("click.fndtn.topbar", ".top-bar .toggle-topbar",function (i) {
            ...
            i.data("index", i.data("index") - 1), n.rtl ? (s.css({right: -(100 * i.data("index")) + "%"}), s.find(">.name").css({right: 100 * i.data("index") + "%"})) : (s.css({left: -(100 * i.data("index")) + "%"}), s.find(">.name").css({left: 100 * i.data("index") + "%"
